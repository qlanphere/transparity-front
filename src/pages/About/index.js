        ...
        <div className="about-page">
            ...
            <div className="slide">
                ...
                <div className="rounded-card">
                    <div className="rounded-description">You can join the <span className="green">Transparity</span> community today by signing up as a <span className="bold">donator</span> or a <span className="bold">charity</span>.
                        ...
                        if you would like to sign up as a charity please select the charity option.</div>
