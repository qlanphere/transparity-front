...
const DispayRating = (props) => {
  ...
  return (
    <div>
      <h6 className="review-total">Total Reviews({totalReviews})</h6>
      {/* <h2>{allPosts}</h2> */}
      {totalReviews !== 0 && <div className="review-container"><p>Transparency: <span className="green">{rating}/5.0</span> </p><p>Punctuality: <span className="green">{punctualityRating}/5.0</span> </p><p>Retention: <span className="green">{returningRating}/5.0 </span></p></div>}
